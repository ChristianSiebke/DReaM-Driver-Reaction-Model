...
public:
    ...
    //-----------------------------------------------------------------------------
    PCM_Trajectory( std::vector<int> *timeVec,
     ...
     *
     */
    std::vector<int> *GetTimeVec() const;
    ...
    //! Re-reference trajectory points to the stupid mid-rear-axle reference point
    //!
    //! @param[in]     trajectory       Trajectory to be copied
    //-----------------------------------------------------------------------------
    void ReReference(PCM_ParticipantData agent);

private:
    std::vector<int> *timeVec = nullptr; //!< vector of the time of the trajectory points
