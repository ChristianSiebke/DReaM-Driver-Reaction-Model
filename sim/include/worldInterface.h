...
public:
    ...
    //! @return
    //-----------------------------------------------------------------------------
    virtual bool CreateScenery(SceneryInterface *scenery, const std::vector<openScenario::TrafficSignalController>& trafficSignalControllers, const openScenario::EnvironmentAction& environment) = 0;
