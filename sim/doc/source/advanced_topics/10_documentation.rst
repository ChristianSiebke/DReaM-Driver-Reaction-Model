...
.. literalinclude:: @OP_REL_SIM@/doc/source/user_guide/sim_user_guide/input/scenery.rst
   :start-at: OP_REL_SIM
   :lines: 1
...
#. **Add a cmake file for documentation preparation**
   ...
   .. literalinclude:: @OP_REL_SIM@/doc/source/advanced_topics/_static/custom_doc/PrepareDocCustom.cmake
      :diff: @OP_REL_SIM@/doc/PrepareDoc.cmake
...
#. **Add a ``doc`` CMake target to your custom build**
   ...
   .. literalinclude:: @OP_REL_SIM@/doc/source/advanced_topics/_static/custom_doc/CMakeLists_doc.cmake
      :emphasize-lines: 23
...
#. **Provide a config file for Sphinx**
   ...
   Customization is done by providing a customized file here, with the open source version as template (:download:`conf.py<@OP_REL_SIM@/doc/source/conf.py>`).
