...
TEST(SimulationConfigImporter_UnitTests, ImportSpawnersSuccessfully)
{
    ...
    EXPECT_NO_THROW(SimulationConfigImporter::ImportSpawners(fakeDocumentRoot, spawnPointsConfig));
...
TEST(SimulationConfigImporter_UnitTests, ImportSpawnersUnsuccessfully)
{
    ...
    ASSERT_THROW(SimulationConfigImporter::ImportSpawners(fakeDocumentRootMissingLibrary, spawnPointConfig), std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportSpawners(fakeDocumentRootMissingType, spawnPointConfig), std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportSpawners(fakeDocumentRootMissingPriority, spawnPointConfig), std::runtime_error);
}
...
TEST(SimulationConfigImporter_UnitTests, ImportObserversSuccessfully)
{
    ...
    EXPECT_NO_THROW(SimulationConfigImporter::ImportObservations(fakeDocumentRoot, observations));
...
TEST(SimulationConfigImporter_UnitTests, ImportExperimentConfigSuccessfully)
{
    ...
    EXPECT_NO_THROW(SimulationConfigImporter::ImportExperiment(fakeDocumentRoot, experimentConfig));
...
TEST(SimulationConfigImporter_UnitTests, ImportExperimentConfigUnsuccessfully)
{
    ...
    ASSERT_THROW(SimulationConfigImporter::ImportExperiment(fakeDocumentRootMissingRandomSeed, experimentConfig), std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportExperiment(fakeDocumentRootWrongDataType, experimentConfig), std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportExperiment(fakeDocumentRootWrongTagName, experimentConfig), std::runtime_error);
}
...
TEST(SimulationConfigImporter_UnitTests, ImportScenarioConfigSuccessfully)
{
    ...
    EXPECT_NO_THROW(SimulationConfigImporter::ImportScenario(fakeDocumentRoot, "configs", scenarioConfig));
...
TEST(SimulationConfigImporter_UnitTests, ImportScenarioConfigUnsuccessfullyMissingTag)
{
    ...
    ASSERT_THROW(SimulationConfigImporter::ImportScenario(fakeDocumentRoot, "configs", scenarioConfig), std::runtime_error);
}
...
TEST(SimulationConfigImporter_UnitTests, ImportEnvironmentConfigSuccessfully)
{
    ...
    EXPECT_NO_THROW(SimulationConfigImporter::ImportEnvironment(fakeDocumentRoot, environmentConfig));
...
TEST(SimulationConfigImporter_UnitTests, ImportEnvironmentConfigUnsuccessfully)
{
    ...
    ASSERT_THROW(SimulationConfigImporter::ImportEnvironment(fakeDocumentRootWrongProbabilities, environmentConfig),
                 std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportEnvironment(fakeDocumentRootMissingAtLeastOneElement, environmentConfig),
                 std::runtime_error);
    ASSERT_THROW(SimulationConfigImporter::ImportEnvironment(fakeDocumentRootMissingTag, environmentConfig),
                 std::runtime_error);
}
