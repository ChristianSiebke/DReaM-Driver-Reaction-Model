...
DReaM is a driver behaviour model and component of the traffic simulation software openPASS. More information about DReaM can be found [here](https://driver-model.de/). 
