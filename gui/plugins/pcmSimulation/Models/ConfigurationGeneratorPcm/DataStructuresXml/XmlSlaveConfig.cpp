...
#include "XmlSlaveConfig.h"

XmlSlaveConfig::XmlSlaveConfig(int startTime, QString endTime, int nInvocations, QString weekday,
...
void XmlSlaveConfig::AddSpawnPoint(XmlSpawnPoint *sp)
{
    spawnPoints.push_back(sp);
}

void XmlSlaveConfig::AddAgent(int id, int agentTypeRef, PCM_ParticipantData *participant)
{
    agents.push_back( XmlAgent(id, agentTypeRef, participant) );
}

void XmlSlaveConfig::AddObservation(XmlObservation *observation)
{
    observations.push_back(observation);
}

bool XmlSlaveConfig::WriteToXml(QXmlStreamWriter *xmlWriter)
{
