...
XmlModel::XmlModel(int id, int agentTypeRef, PCM_ParticipantData participant):
    XmlBaseClass(id),
...
{
    modelName = "Agent_" + QString::number(id);
}

bool XmlModel::WriteToXml(QXmlStreamWriter *xmlWriter)
{
