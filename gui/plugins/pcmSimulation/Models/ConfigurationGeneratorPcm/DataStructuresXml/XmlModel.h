...
class XmlModel: public XmlBaseClass
{
public:
    //-----------------------------------------------------------------------------
    //! Constructor
    ...
    //-----------------------------------------------------------------------------
    XmlModel( int id, int agentTypeRef, PCM_ParticipantData participant );
    ...
    QString modelName;      //!< distance center of gravity to the leading edge of the agent
