...
TrafficSimulationView::TrafficSimulationView(WindowInterface * const window,
    ...
    , actionMenuNew(WindowInterface::createAction(tr("Clear"), this, &TrafficSimulationView::actionNew))
    , actionMenuLoad(WindowInterface::createAction(tr("Load"), this, &TrafficSimulationView::actionLoad))
    , actionMenuSave(WindowInterface::createAction(tr("Save"), this, &TrafficSimulationView::actionSave))
    , actionMenuUndo(WindowInterface::createAction(tr(""), this, &TrafficSimulationView::actionUndo))
    , actionMenuRedo(WindowInterface::createAction(tr(""), this, &TrafficSimulationView::actionRedo))
    , actionMenuHistory(WindowInterface::createAction(tr("Command History"),this, &TrafficSimulationView::actionHistory))
    , ui(new Ui::TrafficSimulationView)
    , statusbar(new StatusBarView(this))
{
    ...
    window->add(ViewID,WindowInterface::createButton(tr("Scenario-based\nSimulation"), 0, 06000),this,{actionMenuNew, actionMenuLoad,actionMenuSave,
                                                                                               actionMenuUndo, actionMenuRedo, actionMenuHistory} );
