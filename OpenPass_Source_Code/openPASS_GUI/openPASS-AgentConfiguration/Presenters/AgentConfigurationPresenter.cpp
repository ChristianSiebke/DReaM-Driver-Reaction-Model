...
AgentConfigurationPresenter::AgentConfigurationPresenter(AgentConfigurationInterface * const agentConfiguration,
    ...
    , undo (new QShortcut(QKeySequence(tr("Ctrl+Z", "undo")),agentConfigurationView))
    , agentsPresenter(new AgentMapPresenter(agentConfiguration->getAgents(),
                                            agentConfiguration->getVehicleProfiles(),
                                            agentConfiguration->getDriverProfiles(),
                                            agentConfigurationView->getAgentsView(),
                                            project,
                                            undoStack,
                                            this))
    , vehicleProfilesPresenter(new VehicleProfilesPresenter(agentConfiguration->getVehicleProfiles(),
                                                            agentConfigurationView->getVehicleProfilesView(),
                                                            system,
                                                            project,
                                                            undoStack,
                                                            this ))
    , driverProfilesPresenter( new DriverProfilesPresenter(agentConfiguration->getDriverProfiles(),
