...
AgentConfigurationModel::AgentConfigurationModel(QObject *parent)
    : AgentConfigurationInterface(parent)
    , agents(new AgentMapModel(this))
    , vehicleProfiles(new VehicleProfileMapModel(this))
    , driverProfiles(new DriverProfileMapModel(this))
    , componentProfiles(new VehicleComponentProfileMapModel(this))
    , sensorProfiles(new SensorProfileMapModel(this))
{
}
