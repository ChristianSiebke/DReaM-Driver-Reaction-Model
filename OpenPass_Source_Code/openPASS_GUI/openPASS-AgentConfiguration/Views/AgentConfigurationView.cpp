...
AgentConfigurationView::AgentConfigurationView(WindowInterface * const window,
    ...
    , actionMenuSave(WindowInterface::createAction(tr("Save"), this, &AgentConfigurationView::actionSave))
    , actionMenuExport(WindowInterface::createAction(tr("Export"), this, &AgentConfigurationView::actionExport))
    , actionMenuLoad(WindowInterface::createAction(tr("Load"), this, &AgentConfigurationView::actionLoad))
    , actionMenuClear(WindowInterface::createAction(tr("Clear"), this, &AgentConfigurationView::actionClear))
    , actionMenuUndo(WindowInterface::createAction(tr(""), this, &AgentConfigurationView::actionUndo))
    , actionMenuRedo(WindowInterface::createAction(tr(""), this, &AgentConfigurationView::actionRedo))
    , actionMenuHistory(WindowInterface::createAction(tr("Command History"),this, &AgentConfigurationView::actionHistory))
    , ui(new Ui::AgentConfigurationView)
{
    // Create UI
    ui->setupUi(this);
