...
public:
    ...
    virtual bool remove(SystemConnectionMapInterface::Item * connection) override;

    virtual SystemConnectionMapInterface::Item * take(SystemConnectionMapInterface::ID const & id) override;

    virtual QList<Item*> values() override;

public Q_SLOTS:
    void removeTargetConnection(SystemConnectionMapInterface::Target const * const target);
    void removeSourceConnection(SystemConnectionMapInterface::Source const * const source);
    void removeComponentConnection(SystemConnectionMapInterface::Component const * const component);
