...
public:
     ...
     *
     * \param eventElement              The OpenSCENARIO-adherent Event element from
     *                                  which to import the manipulator
     * \param eventName                 The name of the event
     * \param trajectoryCatalogPath     Full path to the trajectory catalog file
...
private:
     ...
     *
     * \param privateElement            the Private element to parse
     * \param eventName                 The name of the event
     * \param trajectoryCatalogPath     Full path to the trajectory catalog file
     * \param parameters                declared parameters
     *
     ...
     *        an ActionInterface from which a manipulator may be created
     *
     * \param globalElement     the Global element to parse
     * \param eventName         The name of the event
     * \param parameters        declared parameters
     *
     * \returns a shared_ptr to the ActionInterface containing the parsed data
    ...
    static QDomElement GetTrajectoryElementFromCatalog(const std::string& catalogName, const std::string& catalogPath, const std::string& entryName, openScenario::Parameters& parameters);
};
} // Importer
