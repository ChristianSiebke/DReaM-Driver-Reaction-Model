    ...
    const AgentInterface *agent)
{
    ...
    agentPosition.x = agentPosition.x + std::cos(agentAngle) * agent->GetWheelbase() / 2.0; // geometrical center of vehicle in global CS
    agentPosition.y = agentPosition.y + std::sin(agentAngle) * agent->GetWheelbase() / 2.0; // geometrical center of vehicle in global CS
