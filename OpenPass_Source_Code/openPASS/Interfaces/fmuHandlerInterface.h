...
{
    ComponentState,
    LateralSignal_LaneWidth,
    LateralSignal_LateralDeviation,
    LateralSignal_GainLateralDeviation,
    LateralSignal_HeadingError,
    LateralSignal_GainHeadingError,
    LateralSignal_KappaSet,
...
using Fmu1Inputs = std::map<FmuInputType, fmi1_value_reference_t>;
using Fmu1Outputs = std::map<SignalValue, fmi1_value_reference_t>;
using Fmu2Inputs = std::map<FmuInputType, fmi2_value_reference_t>;
