...
cmake "$CMAKE_GENERATOR_ARG" -D CMAKE_BUILD_TYPE=Release -D FMILIB_INSTALL_PREFIX="$WORKSPACE_ROOT/deps/FMILibrary" -D FMILIB_BUILD_STATIC_LIB=OFF -D FMILIB_BUILD_SHARED_LIB=ON -D FMILIB_BUILD_TESTS=OFF ..
make -j4
make install
