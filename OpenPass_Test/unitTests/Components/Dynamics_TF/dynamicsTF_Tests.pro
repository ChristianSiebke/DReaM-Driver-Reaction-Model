...
TRAJECTORYFOLLOWER_SRC = \
    $$relative_path($$OPEN_SRC)/Components/Dynamics_TF/tfImplementation.cpp

TRAJECTORYFOLLOWER_HDR = \
    $$relative_path($$OPEN_SRC)/Components/Dynamics_TF/tfImplementation.h

COMMON_HDR = \
    $$relative_path($$OPEN_SRC)/Common/vector2d.h

INCLUDEPATH += . \
    $$relative_path($$OPEN_SRC)/Components/Dynamics_TF
